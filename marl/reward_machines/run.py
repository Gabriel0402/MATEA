...
import envs
from reward_machines.rm_environment import RewardMachineWrapper, MARewardMachineWrapper
...
def train(args, extra_args):
    ...
    # alg_kwargs['use_dcg']    = args.use_dcg
...
def build_env(args):
    ...
    if alg in ['deepq', 'qlearning', 'hrm', 'dhrm','maqlearning','cqlearning']:
